...
PRODUCT_COPY_FILES += \
    vendor/sony/eagle/proprietary/bin/mm-pp-daemon:system/vendor/bin/mm-pp-daemon \
    vendor/sony/eagle/proprietary/bin/mm-qcamera-app:system/vendor/bin/mm-qcamera-app \
    vendor/sony/eagle/proprietary/bin/mm-qcamera-daemon:system/vendor/bin/mm-qcamera-daemon \
    vendor/sony/eagle/proprietary/lib/hw/camera.msm8226.so:system/vendor/lib/hw/camera.vendor.msm8226.so \
    vendor/sony/eagle/proprietary/lib/libcamera_clientsemc.so:system/vendor/lib/libcamera_clientsemc.so \
    vendor/sony/eagle/proprietary/lib/libchromatix_imx134_LTO08BS0_liveshot.so:system/vendor/lib/libchromatix_imx134_LTO08BS0_liveshot.so \
    vendor/sony/eagle/proprietary/lib/libchromatix_imx134_LTO08BS0_video_hd.so:system/vendor/lib/libchromatix_imx134_LTO08BS0_video_hd.so \
    vendor/sony/eagle/proprietary/lib/libchromatix_imx134_SOI08BS2_liveshot.so:system/vendor/lib/libchromatix_imx134_SOI08BS2_liveshot.so \
    vendor/sony/eagle/proprietary/lib/libchromatix_imx134_SOI08BS2_video_hd.so:system/vendor/lib/libchromatix_imx134_SOI08BS2_video_hd.so \
    vendor/sony/eagle/proprietary/lib/libcnefeatureconfig.so:system/vendor/lib/libcnefeatureconfig.so \
    vendor/sony/eagle/proprietary/lib/libfaceanalyzer.so:system/vendor/lib/libfaceanalyzer.so \
    vendor/sony/eagle/proprietary/lib/libfaceengine.so:system/vendor/lib/libfaceengine.so \
    vendor/sony/eagle/proprietary/lib/libfilterpack_facedetect.so:system/vendor/lib/libfilterpack_facedetect.so \
    vendor/sony/eagle/proprietary/lib/libfilterpack_imageproc.so:system/vendor/lib/libfilterpack_imageproc.so \
    vendor/sony/eagle/proprietary/lib/libmmcamera_holly_eeprom.so:system/vendor/lib/libmmcamera_holly_eeprom.so \
    vendor/sony/eagle/proprietary/lib/libmmcamera_interface.so:system/vendor/lib/libmmcamera_interface.so \
    vendor/sony/eagle/proprietary/lib/libmmjpeg_interface.so:system/vendor/lib/libmmjpeg_interface.so \
    vendor/sony/eagle/proprietary/lib/libmm-qcamera.so:system/vendor/lib/libmm-qcamera.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_denoiser.so:system/vendor/lib/libmorpho_denoiser.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_easy_hdr.so:system/vendor/lib/libmorpho_easy_hdr.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_edit_engine.so:system/vendor/lib/libmorpho_edit_engine.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_fdw.so:system/vendor/lib/libmorpho_fdw.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_hdr_checker.so:system/vendor/lib/libmorpho_hdr_checker.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_image_stabilizer3.so:system/vendor/lib/libmorpho_image_stabilizer3.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_movie_stabilizer3.so:system/vendor/lib/libmorpho_movie_stabilizer3.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_object_tracker2.so:system/vendor/lib/libmorpho_object_tracker2.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_posture_detect.so:system/vendor/lib/libmorpho_posture_detect.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_scene_detector.so:system/vendor/lib/libmorpho_scene_detector.so \
    vendor/sony/eagle/proprietary/lib/libmorpho_super_resolution.so:system/vendor/lib/libmorpho_super_resolution.so \
    vendor/sony/eagle/proprietary/lib/libqomx_core.so:system/vendor/lib/libqomx_core.so \
